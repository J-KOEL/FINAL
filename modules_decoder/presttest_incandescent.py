# modules_decoder/presttest_incandescent.py
...
def load_data():
    """
    Loads lookup dictionaries for PresTest Incandescent:
    10250T + LightUnit(4) + Lens(rest)
    """
    light_unit_lookup = load_csv_dict(DATA_DIR + "PrestTestIncandescentLightUnit.csv")
    lens_lookup       = load_csv_dict(DATA_DIR + "PrestTestIncandescentLens.csv")
