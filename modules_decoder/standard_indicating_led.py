# modules_decoder/standard_indicating_led.py
...
def load_data():
    """
    Loads lookup dictionaries for Standard Indicating Light (LED):
    10250T + LightUnit(4) + Lens(2) + Voltage(rest)
    """
    light_unit_lookup = load_csv_dict(DATA_DIR + "StandardindicatingLightLEDlightUnit.csv")
    lens_lookup       = load_csv_dict(DATA_DIR + "StandardIndicatingLightLEDLens.csv")
