# modules_decoder/standard_indicating_incandescent.py
...
def load_data():
    """
    Loads lookup dictionaries for Standard Indicating Light (Incandescent):
    10250T + LightUnit(4) + Lens(rest)
    """
    light_unit_lookup = load_csv_dict(DATA_DIR + "StandardIndicatingLightIncandescentLightUnit.csv")
    lens_lookup       = load_csv_dict(DATA_DIR + "StandardIndicatingIncandescentLens.csv")
